...
def main():
	...
	@st.cache # coloca o streamlit em cache para acelerar o processo
	def get_data():
	...
	def train_model():
	    ...
	    y = data["MEDV"]
	    rf_regressor = RandomForestRegressor(n_estimators=1000, max_depth=7, max_features=3)
	...
	# subtitulo
	st.markdown("Este é um Data App utilizado para exibir a solução de Machine Learning para o problema de predição de imóveis de Boston.")
	...
	# criando uma interface para o usuário entrar com os dados
	...
	# para rodar o código neste ambiente do Visual Studio Code:
